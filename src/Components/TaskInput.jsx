...
const TaskInput = () => {
  ...
  return (
    <div>
      ...
      <input value={task} onChange={(e) => setTask(e.target.value)} className='w-[100%] h-11 bg-white border-amber-600 border-2 my-3 rounded-full p-3' type="text" placeholder='Write your task' onKeyDown={(e) => e.key === "Enter" && handleadd()} />
